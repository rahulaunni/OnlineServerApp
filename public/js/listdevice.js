...
$(document).on("click","#middlebar .removedevice",function(){
...
$(document).on("click","#middlebar .keepdevicedetails",function(){
...
$(document).on("click","#middlebar .deletedeviceconfirmbtn",function(){
